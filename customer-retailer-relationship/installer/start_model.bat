@ECHO OFF
TITLE Customer Retailer Relationship
...
CD Customer Retailer Relationship

REM Start the Model
START javaw -Xss10M -Xmx400M -cp %CP% repast.simphony.runtime.RepastMain ./Customer Retailer Relationship.rs
