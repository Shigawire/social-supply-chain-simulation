@ECHO OFF
TITLE Social Simulation Project
...
CD Social Simulation Project

REM Start the Model
START javaw -Xss10M -Xmx400M -cp %CP% repast.simphony.runtime.RepastMain ./Social Simulation Project.rs
