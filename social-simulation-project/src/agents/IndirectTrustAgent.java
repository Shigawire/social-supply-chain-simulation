...
public class IndirectTrustAgent {
	...
	public static ArrayList<Trust> getTrustValue(TrustAgent trustAgent, DeliveryAgent deliveryAgent){
		//looking for the superagent of the trustagent
		SupplyChainMember superAgent= trustAgent.getSupplyChainMember();
		ArrayList<Trust> trust_liste= new ArrayList<Trust>();
		//differnetiates from which class the 
		if(indirectTrustAgent.getCustomerList().get(0).getClass().equals(superAgent.getClass())){
		...
		if(indirectTrustAgent.getDistributorList().get(0).getClass().equals(superAgent.getClass())){
		...
		if(indirectTrustAgent.getRetailerList().get(0).getClass().equals(superAgent.getClass())){
		...
		if(indirectTrustAgent.getWholesalerList().get(0).getClass().equals(superAgent.getClass())){
	...
	private static IndirectTrustAgent getIndirectTrustAgent(){
