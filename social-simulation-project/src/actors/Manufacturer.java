...
{	
	...
	{		
		if (nextDemand - inventoryAgent.getOutgoingInventoryLevel() + deliveryAgent.getShortage() >= 0) {
		...
		// TODO in which far did he already include this by FABIAN, because he wrote the class
			this.productionAgent.produce(nextDemand-inventoryAgent.getOutgoingInventoryLevel() + deliveryAgent.getShortage() - subtractionByTrust);
