...
<div class="container">
    ...
    <div class="col-lg-4">
        ...
        <div class="info">
            ...
            <h5>Trust Dimensions</h5>
            <ul>
                <li><u>Competence:</u> Wert, der angibt, wie positiv die letzten Bestellungen allg. verlaufen sind
                    (Je höher, desto positiver letzte Bestellungen bewertet)
                </li>
                <li><u>Reliability:</u> Je höher, desto größer die Wahrscheinlichkeit, dass Produkte pünktlich oder sogar eher geliefert werden.
                    (Je höher, desto größer Wahrscheinlichkeit, dass Lieferung pünktlich)
                </li>
                <li><u>Quality:</u> Wert, der die Wahrscheinlichkeit angibt, dass 100% der gesendeten Produkte weiterverkauft werden können.
                    (Je höher, desto größer Wahrscheinlichkeit, dass alle Produkte weiterverkaufbar)
                </li>
                <li>
                    <u>Shared Values:</u> Beschreibt die Ähnlichkeit des Wertesystems des Lieferanten (Bspw. Ökologische Nachhaltigkeit)
                    (Je höher, desto ähnlicher Wertvorstellung)
                </li>
            </ul>
        </div>
    ...
    <div class="col-lg-8">
        ...
        <div class="form-group">
            ...
            <p>
                Dabei sind Preis und Lieferzeit nun bei allen Lieferanten gleich. Sie unterscheiden sich in ihren Trust Dimensionen.
            </p>
            <br>
            ...
            <table class="table table-striped table-bordered table-hover">
                <tr>
                    <th></th>
                    <th>Lieferant</th>
                    <th class="danger">Competence</th>
                    <th class="danger">Reliability</th>
                    <th class="danger">Quality</th>
                    <th class="danger">Shared Values</th>
                    <th>Preis</th>
                    <th>Lieferzeit</th>
                </tr>
