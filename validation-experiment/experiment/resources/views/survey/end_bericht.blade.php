...
<div class="container">
    <div class="col-lg-8">
        ...
        <table class="table table-striped table-bordered">
            ...
            <a href="{{ url('/frage2') }}"><button type="submit" class="btn btn-primary">Weiter</button></a>
        <br><br>
    ...
    <div class="col-lg-4">
        ...
        <div class="info">
            ...
            <ul>
                <li>100 € abzüglich 10 € pro verspäteter Woche</li>
            </ul>
            ...
            <ul>
                <li><u>Quality:</u> Wert, der die Wahrscheinlichkeit angibt, wie viele der gesendeten Produkte weiterverkauft werden können.
